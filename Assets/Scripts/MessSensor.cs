...
public class Messsensor: MonoBehaviour
{
    ...
    private Vector2[] beaconEntfernungen = new Vector2[3];
    private Vector2[] beaconEntfernungenDistorted = new Vector2[3];
    ...
    {
      // FRAGE: ist das fine so? (nachträgliche Skalierung)
      float distanceBeacon0 = (beacons[0].transform.position - transform.position).magnitude;
      float distanceBeacon1 = (beacons[1].transform.position - transform.position).magnitude;
      float distanceBeacon2 = (beacons[2].transform.position - transform.position).magnitude;
      
      // GT
      beaconEntfernungen[0] = beaconDirections[0] * distanceBeacon0;
      beaconEntfernungen[1] = beaconDirections[1] * distanceBeacon1;
      beaconEntfernungen[2] = beaconDirections[2] * distanceBeacon2;
      // Distorted 
      beaconEntfernungenDistorted[0] = beaconDirectionsDistorted[0] * distanceBeacon0;
      beaconEntfernungenDistorted[1] = beaconDirectionsDistorted[1] * distanceBeacon1;
      beaconEntfernungenDistorted[2] = beaconDirectionsDistorted[2] * distanceBeacon2;
    }
    ...
    */
    ...
    -- entfernungen 
    [28] 'Entfernung_GT_X_B0', 'Entfernung_GT_Y_B0',
    [30] 'Entfernung_X_B0', 'Entfernung_Y_B0', 'STD_Grad_B0'
    [33] 'Entfernung_GT_X_B1', 'Entfernung_GT_Y_B1', 
    [35] 'Entfernung_X_B1', 'Entfernung_Y_B1', 'STD_Grad_B1'
    [38] 'Entfernung_GT_X_B2', 'Entfernung_GT_Y_B2',
    [40] 'Entfernung_X_B2', 'Entfernung_Y_B1', 'STD_Grad_B2'
    */
    ...
    void WriteExtendedLog()
    {
        ...
        logText += $"\t{beaconDirectionsDistorted[2].x}\t{beaconDirectionsDistorted[2].y}\t{beaconStds[2]}";
        // entfernungen
        logText += $"\t{beaconEntfernungen[0].x}\t{beaconEntfernungen[0].y}";
        logText += $"\t{beaconEntfernungenDistorted[0].x}\t{beaconEntfernungenDistorted[0].y}\t{beaconStds[0]}";
        logText += $"\t{beaconEntfernungen[1].x}\t{beaconEntfernungen[1].y}";
        logText += $"\t{beaconEntfernungenDistorted[1].x}\t{beaconEntfernungenDistorted[1].y}\t{beaconStds[1]}";
        logText += $"\t{beaconEntfernungen[2].x}\t{beaconEntfernungen[2].y}";
        logText += $"\t{beaconEntfernungenDistorted[2].x}\t{beaconEntfernungenDistorted[2].y}\t{beaconStds[2]}";
